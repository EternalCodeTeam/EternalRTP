...
public class TeleportServiceTest {
    ...
    private final TeleportService service = new TeleportService(scheduler, algorithm, range, TeleportPositionCorrector.NONE);
    ...
    public void testWithSimpleFilter() throws InterruptedException {
        ...
        service.registerFilter(position -> CompletableFuture.completedFuture(false));
        service.teleportProfile(testProfile, Universe.NONE, result -> {
