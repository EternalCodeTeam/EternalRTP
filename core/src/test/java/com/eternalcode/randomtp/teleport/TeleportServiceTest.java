...
import com.eternalcode.randomtp.shared.TestProfile;
import com.eternalcode.randomtp.shared.TestScheduler;
...
public class TeleportServiceTest {
    ...
    private final TeleportService service = new TeleportService(scheduler, algorithm, range, HeightCorrector.NONE);
    ...
    public void testWithSimpleFilter() throws InterruptedException {
        ...
        service.registerFilter((universe, position) -> false);
        service.teleportProfile(testProfile, Universe.NONE, result -> {
